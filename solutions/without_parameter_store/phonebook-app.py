...
app.config['MYSQL_DATABASE_PASSWORD'] = 'database_1234'
app.config['MYSQL_DATABASE_DB'] = 'database_phonebook'
...
# Write a function named `init_todo_db` create phonebook table within database_phonebook db, if it doesn't exist

def init_phonebook_db():
    phonebook_table = """
    CREATE TABLE IF NOT EXISTS database_phonebook.phonebook(
